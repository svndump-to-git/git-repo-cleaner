 ...
 */
package io.github.svndump_to_git.cleaner;
...
import io.github.svndump_to_git.cleaner.model.ObjectIdTranslationMapImpl;
...
public class TestFusionDataAwareRevSort extends AbstractGitRespositoryTestCase {
	...
	/* (non-Javadoc)
	 * @see io.github.svndump_to_git.svn.model.AbstractGitRespositoryTestCase#onBefore()
	 */
	@Override
